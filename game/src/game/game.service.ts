...
import { CardspotService } from 'src/cardspot/cardspot.service';
import { Cardset } from 'src/cardset/entities/cardset.entity';
import { CreateCardspotInput } from 'src/cardspot/dto/create-cardspot.input';
...
export class GameService {
  ...
  async findOne(id: string): Promise<Game> {
    const game = this.gameRepository.findOneOrFail(id);
    return game;
  }
